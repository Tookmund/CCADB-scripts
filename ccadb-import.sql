...
CREATE TABLE certificates (
	...
	ev_code_audit_type TEXT,
	ev_code_audit_statement_date TEXT,
	ev_code_audit_start_date TEXT,
	ev_code_audit_end_date TEXT,
...
SELECT
	...
	certrecords."BR Audit URL",
	certrecords."BR Audit Type",
	REPLACE(certrecords."BR Audit Statement Date", ".", "-"),
	REPLACE(certrecords."BR Audit Period Start Date", ".", "-"),
	REPLACE(certrecords."BR Audit Period End Date", ".", "-"),
	certrecords."EV SSL Audit URL",
	certrecords."EV SSL Audit Type",
	REPLACE(certrecords."EV SSL Audit Statement Date", ".", "-"),
	REPLACE(certrecords."EV SSL Audit Period Start Date", ".", "-"),
	REPLACE(certrecords."EV SSL Audit Period End Date", ".", "-"),
	certrecords."EV Code Signing Audit URL",
	certrecords."EV Code Signing Audit Type",
	REPLACE(certrecords."EV Code Signing Audit Statement Date", ".", "-"),
	REPLACE(certrecords."EV Code Signing Audit Period Start Date", ".", "-"),
	REPLACE(certrecords."EV Code Signing Audit Period End Date", ".", "-"),
